...
export default {
  ...
  stampAnotherFile: 'Stamp another file',
  verifyAnotherFile: 'Verify another file',
  sign: 'stamp',
  file: 'File',
  signedBy: 'Signed by',
  id: 'id',
  ...
  notSignedIn: 'Please log in or register to use Timescribe',
  ...
  date: 'Date',
  time: 'Time',
  downloadCertificate: 'View/Download',
  ...
  signingKeyLocked: 'Please unlock your signing key',
  ...
  invalidPinLength: 'You must use 6 numeric characters only',
  verifyTimestamp: 'Verify a timestamp',
  createTimestamp: 'Create a timestamp',
  createFirstTimeStamp: "Let's get you started!",
  createFirstTimeStampContent: 'Would you like to create your first timestamp ?',
